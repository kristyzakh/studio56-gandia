...
(function () {
  ...
  var T = UK ? {
    ...
    offerLead: 'З пакетом 3 + 1 чотири сеанси — ',
    offerInstead: ' замість ',
    courseOff: 'Пакет 3 + 1 — 4 сеанси за ціною 3',
    courseOn: 'Пакет 3 + 1 — 4 сеанси за ціною 3',
    courseHint: 'Показано ціну пакета. Окремими сеансами вийшло б ',
    ...
    saveRe: /ahorras/i,
    offerLead: 'Con el pack 3 + 1, cuatro sesiones — ',
    offerInstead: ' en vez de ',
    courseOff: 'Pack 3 + 1 — 4 sesiones al precio de 3',
    courseOn: 'Pack 3 + 1 — 4 sesiones al precio de 3',
    courseHint: 'Precio del pack. Sesión a sesión saldría ',
